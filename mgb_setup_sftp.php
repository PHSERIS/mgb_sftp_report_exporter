...
// SFTP Key
?>
    <div id="OLD_sftp_conf_result" name="OLD_sftp_conf_result" class="input-div-center" style="display: none">
...
<div id="sftp_config_settings_div" style="width: 70%;">
    ...
    <div>
        ...
        <div id="sftp_result_warn" name="sftp_result_warn" class="input-div-center" style="display: none">
            <table>
                <tr><td colspan="2" style="padding: 15px; font-size: 26px; text-align: center; border: 1px #da963b solid;">
                    <div id="sftp_result_warn_text" name="sftp_result_warn_text" class="input-div-center">
    ...
    <div>
        <div id="OLD_aws_s3_result" name="OLD_aws_s3_result" class="input-div-center" style="display: none"></div>

        <div id="aws_s3_result" name="aws_s3_result" class="input-div-center" style="display: none">
            <table>
                <tr><td colspan="2" class="logt" style="padding: 15px; font-size: 26px; text-align: center;">
                    <div id="aws_s3_result_text" name="aws_s3_result_text" class="input-div-center">
        ...
        <div id="aws_s3_result_warn" name="aws_s3_result_warn" class="input-div-center" style="display: none">
            <table>
                <tr><td colspan="2" style="padding: 15px; font-size: 26px; text-align: center; border: 1px #da963b solid;">
                    <div id="aws_s3_result_warn_text" name="aws_s3_result_warn_text" class="input-div-center">
    ...
    <div>
        <div id="OLD_local_storage_result" name="OLD_local_storage_result" class="input-div-center" style="display: none"></div>

        <div id="local_storage_result" name="local_storage_result" class="input-div-center" style="display: none">
            <table>
                <tr><td colspan="2" class="logt" style="padding: 15px; font-size: 26px; text-align: center;">
                    <div id="local_storage_result_text" name="local_storage_result_text" class="input-div-center">
        ...
        <div id="local_storage_result_warn" name="local_storage_result_warn" class="input-div-center" style="display: none">
            <table>
                <tr><td colspan="2" style="padding: 15px; font-size: 26px; text-align: center; border: 1px #da963b solid;">
                    <div id="local_storage_result_warn_text" name="local_storage_result_warn_text" class="input-div-center">
    ...
    <script type="text/javascript" >
        ...
        function add_sftp_config () {
            ...
            if ( !errfound ) {
                ...
                $("#sftp_result_warn_text").html("");
                $("#sftp_result_warn").css("display","none");
                ...
                $.post( "<?php print $module->getUrl('mgb_setup_sftp_ajax.php'); ?>", {
                    ...
                    //htmltext = "<table>";
                    //htmltext += "<tr><td colspan='2' class='logt' style='padding: 15px; font-size: 26px; text-align: center;'>Config OK</td></tr>";
                    //htmltext += "</table>";

                    //$("#sftp_conf_result").html(htmltext);
                ...
                //htmltext = "<table>";
                //htmltext += "<tr><td colspan='2' style='padding: 15px; font-size: 26px; text-align: center; border: 1px #da963b solid;'>Please Check the values provided!</td></tr>";
                //htmltext += "</table>";

                //$("#sftp_result").html(htmltext);
                $("#sftp_result_warn_text").html("Please Check the values provided!");
                $("#sftp_result_warn").css("display","block");
            }
        }
        ...
        function delete_sft_config ( num ) {
            $.post( "<?php print $module->getUrl('mgb_setup_sftp_rm_ajax.php'); ?>", {
                ...
                //htmltext = "<table>";
                //htmltext += "<tr><td colspan='2' class='logt' style='padding: 15px; font-size: 26px; text-align: center;'>Config Deleted</td></tr>";
                //htmltext += "</table>";
        ...
        function select_sftp_remote_location( num ) {
            ...
            $.post("<?php print $module->getUrl('mgb_setup_sftp_location_ajax.php'); ?>", {
                ...
                if (data.includes('Cannot')) {  // we have hit an exception with the connection
                    $('#sftp_folder_cfg_'+num).html("Error Cannot Connect");
                    return false;
                }
                if (data.includes('timed out')) {  // we have hit an exception with the connection
                    $('#sftp_folder_cfg_'+num).html("Error Connect Time out");
                    return false;
                }
                ...
                if (json_data.length < 1) {
                    //alert('woops');
                    $('#sftp_folder_cfg_'+num).html("Loading Error ");
                    return false;
                }
        ...
        function savepathdata( path, num ) {
            ...
            $.post("<?php print $module->getUrl('mgb_setup_sftp_location_ajax.php'); ?>", {
                ...
                //htmltext = "<table>";
                //htmltext += "<tr><td colspan='2' class='logt' style='padding: 15px; font-size: 26px; text-align: center;'>Target Folder Set OK!</td></tr>";
                //htmltext += "</table>";
        ...
        function add_aws_s3_config( ) {
            ...
            if ( !errfound ) {
                // Post to the service
                $("#aws_s3_result_text").html("");
                $("#aws_s3_result_warn_text").html("");
                $("#aws_s3_result").css("display","none");
                $("#aws_s3_result_warn").css("display","none");
                ...
                $.post( "<?php print $module->getUrl('mgb_setup_sftp_ajax.php'); ?>", {
                    ...
                    //$("#aws_s3_result").html(htmltext);
                    $("#aws_s3_result_text").html("S3 Config OK");
                ...
                //$("#aws_s3_result").html(htmltext);
                //$("#aws_s3_result").css("display","block");
                $("#aws_s3_result_warn_text").html("Please Check the S3 Bucket values provided!");
                $("#aws_s3_result_warn").css("display","block");
            }
        }
        ...
        function add_local_storage_config () {
            ...
            if ( !errfound ) {
                // Post to the service
                $("#local_storage_result_text").html("");
                $("#local_storage_result_warn_text").html("");
                $("#local_storage_result").css("display","none");
                $("#local_storage_result_warn").css("display","none");
                ...
                $.post( "<?php print $module->getUrl('mgb_setup_sftp_ajax.php'); ?>", {
                    ...
                    //$("#local_storage_result").html(htmltext);
                    $("#local_storage_result_text").html("LOCAL Config OK");
                ...
                $("#local_storage_result_warn_text").html("Please Check the Local values provided!");
                $("#local_storage_result_warn").css("display","block");
            }
        }
    </script>
<style>
